...
if ($num != 0 ) {
 ...
 mysql_query("INSERT INTO djokes(title,category,joke,status) 
	VALUES ('$_POST[title]', '$category', '$_POST[joke]','pending')") or die(mysql_error());

}

echo "<h2>Jokes have been save.</h2>";
echo "Return to <a href = '$siteurl/admin2/entry.php'>Enter new joke again</a> | <a href = '$siteurl'>Home</a>";
